    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch(action){
            ...
            case "delete":
                ...
                long serch = Long.parseLong(request.getParameter("id"));  
                request.setAttribute("user", new DaoUser().findById(serch));

                if(new DaoUser().delete(serch)){
                    request.setAttribute("message", "Se ha eliminado al ususario");
                } else {
                    request.setAttribute("message", "No se ha eliminado al usuario");
                }doGet(request,response);
                break;
            default:
                // no supported
